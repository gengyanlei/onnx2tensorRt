...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default='cfg/yolov4-sg.cfg', help='yolo cfg file')
    parser.add_argument('--weights_file', type=str, default='/home/gengyanlei/Python_work/darknet_yolov4/backup_sg/yolov4-sg_best.weights', help='yolo weights file')
    parser.add_argument('--output_file', type=str, default='yolov4_608.onnx', help='yolo onnx file')
